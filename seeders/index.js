...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'EufUubh3JKDXfEO',
      'isDeleted':false,
      'username':'Mohammad8',
      'email':'Kristina.Grant21@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let user = await dbService.updateOne(User, { 'username':'Mohammad8' }, userToBeInserted,  { upsert: true });
    userToBeInserted = {
      'password':'LOj3uZgr_N78mwQ',
      'isDeleted':false,
      'username':'Ciara_Mertz',
      'email':'Ahmed_Feeney@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await  bcrypt.hash(userToBeInserted.password, 8);
    let admin = await dbService.updateOne(User, { 'username':'Ciara_Mertz' }, userToBeInserted,  { upsert: true });
