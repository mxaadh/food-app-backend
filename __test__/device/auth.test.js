...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Ona50',
      password: 'azo1wmVZ9F_wktA',
      email: 'Daphney_Smith@hotmail.com',
      name: 'Willard Wuckert',
      userType: 139,
      mobileNo: '(528) 654-1020',
      resetPasswordLink: {},
      loginRetryLimit: 630,
      loginReactiveTime: '2024-10-12T07:35:06.723Z',
      id: '65e8d7769174eb0363b01a2c'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Julio_Windler',
        'password':'TuieSNuLmNAEeWy',
        'email':'Austen10@gmail.com',
        'name':'Mrs. Alison Schoen',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(277) 950-2904',
