...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Gwen_Ondricka',
      password: 'mjV7okf0kZ5zw9U',
      email: 'Concepcion77@yahoo.com',
      name: 'Jamie Emmerich',
      userType: 222,
      mobileNo: '(424) 612-0082',
      resetPasswordLink: {},
      loginRetryLimit: 524,
      loginReactiveTime: '2024-11-29T02:50:11.857Z',
      id: '65e8d7769174eb0363b01a02'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Rory_Schuster91',
        'password':'nQFD_RL8zCH0Dd4',
        'email':'Vida88@yahoo.com',
        'name':'Chris Hyatt',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(838) 523-7311',
